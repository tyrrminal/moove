#<<<
use utf8;
package Moove::Model::Result::EventReference;
...
Related object: L<Moove::Model::Result::EventReferenceType>

=cut

__PACKAGE__->belongs_to(
  "event_reference_type",
  "Moove::Model::Result::EventReferenceType",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:aBzm+61eS4UNIsH8lyafNQ
