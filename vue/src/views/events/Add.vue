<template>
  <b-container>
      ...
      <b-col cols="6">
        <b-card class="mt-2" no-body v-if="eventGroup">
          <b-card-header
            ><strong
              >Parent Event
              <b-icon v-if="eventGroup" icon="lock-fill" /></strong
          ></b-card-header>
          <b-card-body>
            <b-form-group>
      ...
      <b-card-body>
        ...
        <b-form-group label="Address" label-cols="1">
          <b-input-group>
            ...
            />
            <template #append>
              <b-button variant="warning" @click="makeNewAddress"
                >Change</b-button
              >
            </template>
          </b-input-group>
        ...
        <b-row>
              ...
              <b-input-group>
                ...
                <template #append>
                  <b-button
                    ...
                    @click="newEvent.event.externalDataSourceID = null"
                    ><b-icon icon="x"
                  /></b-button>
                </template>
              </b-input-group>
          ...
          <b-col cols="4">
            <b-form-group
              label="Results Event ID"
              label-cols="4"
              content-cols="6"
            >
              <b-input
                v-model="newEvent.event.externalIdentifier"
                :disabled="!newEvent.event.externalDataSourceID"
              />
            </b-form-group>
          </b-col>
        </b-row>
    ...
    <b-card class="mt-2 mb-4" no-body>
      ...
      <b-card-body>
        <div
          v-for="(a, i) in newEvent.eventActivities"
          :key="i"
        ...
        >
          <div class="float-right">
            <b-button
              v-if="i > 0"
              variant="danger"
              @click="newEvent.eventActivities.splice(i, 1)"
              size="sm"
              ><b-icon icon="x"
            /></b-button>
          </div>
          <b-row class="pt-2">
            <b-col cols="4">
              <b-form-group label="Name" label-cols="3">
                <b-input
                  v-model="a.name"
                  title="Required when Event has multiple activities"
                />
              </b-form-group>
            </b-col>
            <b-col cols="4">
          ...
          <b-form-group
            label="Results Activity ID"
            label-cols="2"
            content-cols="2"
          >
            <b-input
              v-model="a.externalIdentifier"
              :disabled="!newEvent.event.externalDataSourceID"
            />
          </b-form-group>
        </div>
    ...
    <b-button @click="saveEvent" class="mb-4 float-right" variant="primary"
      >Save</b-button
    >
