#<<<
use utf8;
package Moove::Model::Result::LiftActivitySet;
...
=head1 TABLE: C<LiftActivitySet>

=cut

__PACKAGE__->table("LiftActivitySet");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+i7dbpajEx3Sxtqi2WplWQ
