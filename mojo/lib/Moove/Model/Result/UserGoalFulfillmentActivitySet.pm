#<<<
use utf8;
package Moove::Model::Result::UserGoalFulfillmentActivitySet;
...
=head1 TABLE: C<UserGoalFulfillmentActivitySet>

=cut

__PACKAGE__->table("UserGoalFulfillmentActivitySet");
...
=item * L</activity_set_id>

=back

=cut

__PACKAGE__->set_primary_key("user_goal_fulfillment_id", "activity_set_id");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:4tY6qfeYc6wLmt9Gn/kwhg
