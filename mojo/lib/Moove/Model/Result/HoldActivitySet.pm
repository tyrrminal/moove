#<<<
use utf8;
package Moove::Model::Result::HoldActivitySet;
...
=head1 TABLE: C<HoldActivitySet>

=cut

__PACKAGE__->table("HoldActivitySet");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:AF6XErl6wJXK0Pb3STL1PA
